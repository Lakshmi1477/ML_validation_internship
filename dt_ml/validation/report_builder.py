...
def _build_execution_table(font_name: str, execution_snapshot: dict[str, Any]) -> Table:
    ...
    data = [
        ...
        ["Baseline total revenue", _format_currency(execution_snapshot["baseline"].get("estimated_revenue"))],
        ["Baseline rows", _safe_number(execution_snapshot["baseline"].get("rows"))],
...
def build_validation_report(
    ...
    summary_data = [
        ...
        ["Baseline revenue", _format_currency(baseline.get("estimated_revenue"))],
        ["Baseline rows", _safe_number(baseline.get("rows"))],
    ]
    ...
    story.append(Paragraph("main.py Execution Snapshot", heading_style))
    story.append(
        Paragraph(
